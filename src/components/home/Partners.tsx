...
const partnersList: PartnerProps[] = [
  {
    ...
    colour: '#ab3994',
    description:
      'The mStable protocol programmatically and automonously lends deposits onto Aave lending markets',
    href: 'https://aave.com/',
    image: Aave,
  },
  {
  ...
  },
  {
    ...
    colour: '#fff',
    description:
      'The mStable protocol leverages Balancer to produce deep liquidity for mStable assets',
  ...
  },
  {
    ...
    colour: '#00d395',
    description:
      'The mStable protocol programmatically and autonomously lends deposits onto Compound lending markets',
