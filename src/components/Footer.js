...
export default () => (
	<footer>
		...
		<div className='wrap'>
			...
			<p>
				Stability Labs GmbH<br />
				Stability Labs Pty Ltd
			</p>

			<address>
				Bourke Street, Melbourne,<br />
				Australia 3000
			</address>

			<address>
				Full Node Skalitzer Str. 85<br />
				Berlin, Germany
			</address>
			...
			<div id='social'>
				...
				<a href='https://discord.gg/raSYRj' target='_blank' rel='noopener noreferrer'>
					<svg xmlns="http://www.w3.org/2000/svg"
						...
						viewBox="0 0 512 512">
						<path d="m346 392-21-25c41-11 57-39 57-39-52 49-194 51-249 0 0 0 14 26 56 39l-23 25c-70-1-97-48-97-48 0-104 46-187 46-187 47-33 90-33 90-33l3 4c-58 16-83 42-83 42 68-46 208-42 263 0 1-1-33-28-86-42l5-4s43 0 90 33c0 0 46 83 46 187 0 0-27 47-97 48z" fill="currentColor"/><ellipse cx="196" cy="279" rx="33" ry="35"/><ellipse cx="312" cy="279" rx="33" ry="35"/>
					</svg>
				</a>
				...
				<a href='mailto:info@mstable.org '>
					<svg xmlns="http://www.w3.org/2000/svg"
						...
						<path fill="currentColor" stroke="black" strokeWidth="20" d="M434 128L269 292c-7 8-19 8-26 0L78 128m0 256l129-128m227 128L305 256"/>
					</svg>
				</a>
